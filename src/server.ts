...
import stockHealthReportRoutes from "./routes/stock-health-report.routes";
...
app.use(Endpoints.STOCK_HEALTH_REPORTS.BASE, stockHealthReportRoutes);
...
app.use(Endpoints.ALERTS.BASE, alertRoutes);
