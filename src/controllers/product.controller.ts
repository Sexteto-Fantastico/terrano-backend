...
async function getAllProducts(
  req: Request<{}, ProductResponseDTO[], {}, ProductQueryDTO>,
...
async function getProductById(
  req: Request<{ id: string }, ProductResponseDTO, {}>,
  res: Response<ProductResponseDTO>
) {
...
async function createProduct(
  req: Request<{}, ProductResponseDTO, CreateProductRequestDTO>,
  res: Response<ProductResponseDTO>
) {
...
async function updateProduct(
  req: Request<{ id: string }, ProductResponseDTO, any>,
  res: Response<ProductResponseDTO>
) {
  const id = Number(req.params.id);
