...
export const definePasswordSchema = z.object({
  body: DefinePasswordBodySchema,
});
export type DefinePasswordRequestDto = z.infer<
  typeof definePasswordSchema
>["body"];
...
export const CreateUserBodySchema = registry.register(
  ...
  z.object({
    ...
    email: z
      .email("Invalid email format")
      .openapi({ example: "john@terrano.com" }),
    username: z
      .string()
...
export const UserResponseSchema = registry.register(
  ...
  z.object({
    ...
    role: RoleResponseSchema.optional().openapi({
      example: { id: 1, name: "Admin" },
    }),
    department: DepartmentResponseSchema.optional().openapi({
      example: { id: 1, name: "IT" },
    }),
    managedDepartments: z
      .array(DepartmentResponseSchema)
      .openapi({ example: [{ id: 1, name: "IT" }] }),
