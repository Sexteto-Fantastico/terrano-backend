...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: { [ContentType.JSON]: { schema: CreateProductBodySchema } },
      },
    },
    responses: {
      201: {
  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: { schema: z.array(ProductResponseSchema) },
        },
      },
    },
  },
...
createRoute(
  router,
  {
    ...
    request: {
      params: productIdSchema.shape.params,
      body: {
        content: { [ContentType.JSON]: { schema: UpdateProductBodySchema } },
      },
    },
    responses: {
      200: {
