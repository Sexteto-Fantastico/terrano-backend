  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: {
            schema: z.array(MeasurementUnitResponseSchema),
          },
        },
      },
    },
  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: { schema: MeasurementUnitResponseSchema },
        },
      },
...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: {
          [ContentType.JSON]: { schema: CreateMeasurementUnitBodySchema },
        },
      },
    },
    responses: {
...
createRoute(
  router,
  {
    ...
    request: {
      ...
      body: {
        content: {
          [ContentType.JSON]: { schema: UpdateMeasurementUnitBodySchema },
        },
      },
    },
    responses: {
