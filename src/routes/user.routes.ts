...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: { [ContentType.JSON]: { schema: CreateUserBodySchema } },
      },
    },
    responses: {
      201: {
  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: { schema: z.array(UserResponseSchema) },
        },
      },
    },
  },
...
createRoute(
  router,
  {
    ...
    request: {
      params: userIdParamsSchema.shape.params,
      body: {
        content: { [ContentType.JSON]: { schema: ChangePasswordBodySchema } },
      },
    },
    responses: {
      200: {
...
createRoute(
  router,
  {
    ...
    request: {
      params: userIdParamsSchema.shape.params,
      body: {
        content: { [ContentType.JSON]: { schema: UpdateUserBodySchema } },
      },
    },
    responses: {
      200: {
...
createRoute(
  router,
  {
    ...
    request: {
      params: userIdParamsSchema.shape.params,
      body: {
        content: { [ContentType.JSON]: { schema: DeleteUserBodySchema } },
      },
    },
    responses: {
...
createRoute(
  router,
  {
    ...
    request: {
      params: userIdParamsSchema.shape.params,
      body: {
        content: { [ContentType.JSON]: { schema: RestoreUserBodySchema } },
      },
    },
    responses: {
      200: {
