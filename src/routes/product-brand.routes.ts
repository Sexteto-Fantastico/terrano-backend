...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: {
          [ContentType.JSON]: { schema: CreateProductBrandBodySchema },
        },
      },
    },
    responses: {
  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: { schema: z.array(ProductBrandResponseSchema) },
        },
      },
    },
  },
...
createRoute(
  router,
  {
    ...
    request: {
      ...
      body: {
        content: {
          [ContentType.JSON]: { schema: UpdateProductBrandBodySchema },
        },
      },
    },
    responses: {
