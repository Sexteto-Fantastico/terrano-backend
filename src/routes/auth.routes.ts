...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: { [ContentType.JSON]: { schema: ForgotPasswordBodySchema } },
      },
    },
    responses: {
...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: { [ContentType.JSON]: { schema: ResetPasswordBodySchema } },
      },
    },
    responses: {
...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: { [ContentType.JSON]: { schema: DefinePasswordBodySchema } },
      },
    },
    responses: {
