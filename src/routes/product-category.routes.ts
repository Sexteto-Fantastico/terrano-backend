...
createRoute(
  router,
  {
    ...
    request: {
      body: {
        content: {
          [ContentType.JSON]: { schema: CreateProductCategoryBodySchema },
        },
      },
    },
    responses: {
      201: {
        ...
        content: {
          [ContentType.JSON]: { schema: ProductCategoryResponseSchema },
        },
      },
    },
  },
  ...
  router,
  {
    ...
    responses: {
      200: {
        ...
        content: {
          [ContentType.JSON]: {
            schema: z.array(ProductCategoryResponseSchema),
          },
        },
      },
    },
...
createRoute(
  router,
  {
    ...
    request: {
      ...
      body: {
        content: {
          [ContentType.JSON]: { schema: UpdateProductCategoryBodySchema },
        },
      },
    },
    responses: {
